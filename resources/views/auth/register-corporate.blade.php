...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Registro de Pessoa Jurídica') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register.corporate') }}">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6">
                                <input id="trading_name" type="text" class="form-control @error('trading_name') is-invalid @enderror" name="trading_name" value="{{ old('trading_name') }}" autocomplete="trading_name">
